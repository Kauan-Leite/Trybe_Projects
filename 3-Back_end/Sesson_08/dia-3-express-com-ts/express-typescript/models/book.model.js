...
var BookModel = /** @class */ (function () {
    ...
    BookModel.prototype.getById = function (id) {
        return __awaiter(this, void 0, void 0, function () {
            var result, rows, book;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.connection
    ...
    BookModel.prototype.update = function (id, book) {
        return __awaiter(this, void 0, void 0, function () {
            var title, price, author, isbn;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        title = book.title, price = book.price, author = book.author, isbn = book.isbn;
                        return [4 /*yield*/, this.connection.execute('UPDATE books SET title=?, price=?, author=?, isbn=? WHERE id=?', [title, price, author, isbn, id])];
                    case 1:
                        _a.sent();
                        return [2 /*return*/];
                }
    ...
    BookModel.prototype.remove = function (id) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.connection.execute('DELETE FROM books WHERE id=?', [id])];
                    case 1:
                        _a.sent();
                        return [2 /*return*/];
                }
